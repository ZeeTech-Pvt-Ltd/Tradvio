        ...
        <section className="relative py-20 md:py-24 bg-deep overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto px-6 relative z-10 text-center">
            <h1 className="text-[clamp(2.4rem,5vw,4.2rem)] font-bold leading-[1.05] -tracking-[0.02em] mb-6">
              {t('cu.title1')} <span className="text-accent">{t('cu.title2')}</span>
            </h1>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div>
                ...
                <h2 className="text-[clamp(1.8rem,3.5vw,2.6rem)] font-bold leading-[1.1] -tracking-[0.02em] mb-5">
                  {t('cu.reach1')}<br />
                  <span className="text-ink-soft font-light italic">{t('cu.reach2')}</span>
                </h2>
                ...
                <div className="bg-navy border border-border rounded-xl p-5 flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-semibold text-ink text-sm mb-0.5">{t('cu.help')}</div>
                    <a href="#replain-link" className="text-sm text-accent hover:text-accent-hover font-semibold">{t('cu.liveSupport')}</a>
                  </div>
                </div>

                {/* Stay connected */}
                <div className="mt-8">
                  <div className="text-xs font-semibold uppercase tracking-[0.14em] text-accent mb-3">{t('cu.stay')}</div>
              ...
              <div>
                <LeadForm
                  formName="contact_us"
                  title={t('cu.formTitle')}
                  subtitle={t('cu.formSub')}
                  ctaText={t('cu.formCta')}
