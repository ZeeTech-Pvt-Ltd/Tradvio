          ...
          {testimonials.map((tm, ti) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                {/* Avatar */}
                <div
                  className={`w-10 h-10 rounded-full ${tm.avatarBg} flex items-center justify-center flex-shrink-0 ring-2 ring-white/10`}
                >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[9px] text-accent font-medium">{tLang('test.verified')}</span>
                  </div>
                  <div className="flex items-center gap-1.5 mt-0.5">
                    ...
                    <div className="flex items-center gap-px">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <svg
                          key={star}
                          className={`w-2.5 h-2.5 ${star <= tm.rating ? 'text-warning' : 'text-[#333]'}`}
                          viewBox="0 0 24 24"
                          fill="currentColor"
                        >
                          <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                    ...
                    <span className="text-[10px] text-ink-soft">{tLang('test.d' + (ti + 1))}</span>
                  </div>
                </div>
              </div>
